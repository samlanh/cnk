var currentScreenTheme = function(){
    ...
    var handleShowPass = function(){
		jQuery('.show-pass').on('click',function(){
			...
			if(jQuery('#capp-password').attr('type') == 'password'){
				jQuery('#capp-password').attr('type','text');
			}else if(jQuery('#capp-password').attr('type') == 'text'){
				jQuery('#capp-password').attr('type','password');
			}
			
			if(jQuery('.control-password').attr('type') == 'password'){
				jQuery('.control-password').attr('type','text');
			}else if(jQuery('.control-password').attr('type') == 'text'){
				jQuery('.control-password').attr('type','password');
			}
		});
	}
...
jQuery(window).on('resize',function () {
	'use strict'; 
	currentScreenTheme.resize();
	
});
/*  Window Resize END */
function showToastMessage(messageString="",newClass="toast-danger"){
	
	if(messageString!=""){
		$("#toastMessage").removeClass("toast-danger");
		$("#toastMessage").addClass(newClass);
		$(".toast-content").html(messageString);
