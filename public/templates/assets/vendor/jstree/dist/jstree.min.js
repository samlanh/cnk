    ...
    if (!a.jstree) {
        ...
        a.jstree.core.prototype = {
            ...
            _create_prototype_node: function() {
                ...
                return a.setAttribute("role", "none"),
                b = i.createElement("I"),
                ...
                .bind(this)).on("keypress.jstree", function(d) {
                    ...
                    b.length > 1) {
                        if (f.slice(g).each(function(c, d) {
                            return 0 === a(d).text().toLowerCase().indexOf(b) ? (a(d).trigger("focus"),
                            h = !0,
                            !1) : void 0
                        }
                        .bind(this)),
                    ...
                    if (new RegExp("^" + e.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") + "+$").test(b)) {
                        if (f.slice(g + 1).each(function(b, c) {
                            return a(c).text().toLowerCase().charAt(0) === e ? (a(c).trigger("focus"),
                            h = !0,
                            !1) : void 0
                        }
                        .bind(this)),
            ...
            _load_node: function(b, c) {
                ...
                .bind(this))) : (e = a.vakata.is_array(d) ? a.extend(!0, [], d) : a.isPlainObject(d) ? a.extend(!0, {}, d) : d,
            ...
            redraw_node: function(b, c, d, e) {
                ...
                this.settings.core.compute_elements_positions && (b.childNodes[1].setAttribute("aria-setsize", p[f.parent].children.length),
            ...
            set_state: function(c, d) {
                if (c) {
                    ...
                    c.core) {
                        var e, f, g, h, i;
                        if (c.core.loaded)
                            return this.settings.core.loaded_state && a.vakata.is_array(c.core.loaded) && c.core.loaded.length ? this._load_nodes(c.core.loaded, function(a) {
                            ...
                            !1;
                        if (c.core.open)
                            return a.vakata.is_array(c.core.open) && c.core.open.length ? this._load_nodes(c.core.open, function(a) {
            ...
            refresh: function(b, c) {
                ...
                b || (this.element.html("<ul class='" + d + "' role='group'><li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='none' id='j" + this._id + "_loading'><i class='jstree-icon jstree-ocl'></i><a class='jstree-anchor' role='treeitem' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("Loading ...") + "</a></li></ul>"),
                this.element.attr("aria-activedescendant", "j" + this._id + "_loading")),
        ...
        a.jstree.plugins.checkbox = function(c, d) {
            this.bind = function() {
                ...
                .bind(this)),
                this.settings.checkbox.tie_selection || this.element.on("model.jstree", function(a, b) {
                ...
                .bind(this)),
                (-1 !== this.settings.checkbox.cascade.indexOf("up") || -1 !== this.settings.checkbox.cascade.indexOf("down")) && this.element.on("model.jstree", function(b, c) {
                ...
                .bind(this)),
                -1 !== this.settings.checkbox.cascade.indexOf("up") && this.element.on("delete_node.jstree", function(b, c) {
            ...
            this.redraw_node = function(a, b, c, e) {
                if (a = d.redraw_node.apply(this, arguments)) {
                    ...
                    h && (!this.settings.checkbox.tie_selection && this._model.data[a.id].state.checked && (h.className += " jstree-checked"),
                    i = l.cloneNode(!1),
                    this._model.data[a.id].state.checkbox_disabled && (i.className += " jstree-checkbox-disabled"),
                    h.insertBefore(i, h.childNodes[0]))
                }
                return c || -1 === this.settings.checkbox.cascade.indexOf("undetermined") || (this._data.checkbox.uto && clearTimeout(this._data.checkbox.uto),
                this._data.checkbox.uto = setTimeout(this._undetermined.bind(this), 50)),
                a
            }
            ,
            ...
            this.load_node = function(b, c) {
                var e, f, g, h, i, j;
                if (!a.vakata.is_array(b) && !this.settings.checkbox.tie_selection && (j = this.get_node(b),
                j && j.state.loaded))
                    for (e = 0,
        ...
        a.jstree.plugins.contextmenu = function(c, d) {
            ...
            this.show_contextmenu = function(c, d, e, f) {
                ...
                k = g.items,
                a.vakata.is_function(k) && (k = k.call(this, c, function(a) {
        ...
        function(a) {
            ...
            a.vakata.context = {
                ...
                _execute: function(b) {
                    return b = c.items[b],
                    b && (!b._disabled || a.vakata.is_function(b._disabled) && !b._disabled({
                        item: b,
                        reference: c.reference,
                        element: c.element
                ...
                _parse: function(b, d) {
                    ...
                    a.each(b, function(b, d) {
                        ...
                        f = !1,
                        e += "<li class='" + (d._class || "") + (d._disabled === !0 || a.vakata.is_function(d._disabled) && d._disabled({
                            item: d,
                            reference: c.reference,
                            element: c.element
                        ...
                        e += (a.vakata.is_function(d.label) ? d.label({
                            item: b,
                            reference: c.reference,
                            element: c.element
                        ...
                        g && (e += g)),
                        e += "</li>",
                        void (d.separator_after && (e += "<li class='vakata-context-separator'><a href='#' " + (a.vakata.context.settings.icons ? "" : 'class="vakata-context-no-icons"') + ">&#160;</a></li>",
                        f = !0))) : !0
                    }),
                ...
                hide: function() {
                    c.is_visible && (c.element.hide().find("ul").hide().end().find(":focus").trigger("blur").end().detach(),
                    c.is_visible = !1,
            ...
            a(function() {
                ...
                c.element.on("mouseenter", "li", function(b) {
                    ...
                    case 32:
                        ...
                        break;
                    case 37:
                        c.is_visible && (c.element.find(".vakata-context-hover").last().closest("li").first().find("ul").hide().find(".vakata-context-hover").removeClass("vakata-context-hover").end().end().children("a").trigger("focus"),
                        b.stopImmediatePropagation(),
                        b.preventDefault());
                        break;
                    case 38:
                        ...
                        break;
                    case 39:
                        c.is_visible && (c.element.find(".vakata-context-hover").last().children("ul").show().children("li:not(.vakata-context-separator)").removeClass("vakata-context-hover").first().addClass("vakata-context-hover").children("a").trigger("focus"),
                        b.stopImmediatePropagation(),
                        b.preventDefault());
                        break;
                    case 40:
        ...
        a.jstree.plugins.dnd = function(b, c) {
            ...
            this.bind = function() {
                c.bind.call(this),
                this.element.on(this.settings.dnd.use_html5 ? "dragstart.jstree" : "mousedown.jstree touchstart.jstree", this.settings.dnd.large_drag_target ? ".jstree-node" : ".jstree-anchor", function(b) {
                    ...
                    c && c.id && c.id !== a.jstree.root && (1 === b.which || "touchstart" === b.type || "dragstart" === b.type) && (this.settings.dnd.is_draggable === !0 || a.vakata.is_function(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, d > 1 ? this.get_top_selected(!0) : [c], b))) {
                        ...
                        !this.settings.dnd.use_html5)
                            ...
                            a.vakata.dnd.start(b, m, '<div id="jstree-dnd" class="jstree-' + this.get_theme() + " jstree-" + this.get_theme() + "-" + this.get_theme_variant() + " " + (this.settings.core.themes.responsive ? " jstree-dnd-responsive" : "") + '"><i class="jstree-icon jstree-er"></i>' + e + '<ins class="jstree-copy">+</ins></div>');
                ...
                if (!e) {
                    ...
                    h.length) {
                        if (a.vakata.is_function(g))
                            return g.call(this, h, function(a) {
                                var g, h;
                                if (a)
                                    for (g in a)
        ...
        a.jstree.plugins.search = function(c, d) {
            this.bind = function() {
                ...
                this.element.on("search.jstree", function(b, c) {
        ...
        a.jstree.plugins.sort = function(a, b) {
            this.bind = function() {
                b.bind.call(this),
                this.element.on("model.jstree", function(a, b) {
            ...
            this.sort = function(a, b) {
                ...
                a && a.children && a.children.length && (a.children.sort(this.settings.sort.bind(this)),
                b))
                    for (c = 0,
                    d = a.children_d.length; d > c; c++)
